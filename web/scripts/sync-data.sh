...
for f in california_county_data.csv california_zip_data.csv california_zip_history.csv cdi_county_market_share.csv cdi_distressed_list.csv distressed_zip_reconciliation.csv fair_statewide_history.csv site_stats.json quarterly_totals.json; do
